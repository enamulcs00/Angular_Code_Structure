...
function ChangepwdComponent_mat_error_14_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-error");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1, " Confirm Password is required");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} }
function ChangepwdComponent_mat_error_15_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-error");
...
class ChangepwdComponent {
    ...
    updatePwd() {
        ...
        if (this.isSubmitted && this.changePwdForm.valid) {
            ...
            this._apiService.postRequest('api/v1/admin/reset', obj).subscribe((response) => {
...
ChangepwdComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: ChangepwdComponent, selectors: [["app-changepwd"]], decls: 20, vars: 5, consts: [[1, "login-register", "align-items-center", "d-flex", 2, "background-image", "url(assets/images/background/login-register.jpg)"], [1, "login-box", "card"], [1, "card-body"], [1, "form-horizontal", 3, "formGroup"], [1, "form-group"], [1, "col-xs-12"], ["type", "text", "required", "", "placeholder", "Password", "formControlName", "password", 1, "form-control"], [4, "ngIf"], ["type", "text", "required", "", "placeholder", " Confirm Password", "formControlName", "confirmpassword", 1, "form-control"], [1, "form-group", "text-center"], ["type", "submit", 1, "btn-primary", "btn-lg", "btn-block", "text-uppercase", "waves-effect", "waves-light", "text-white", 3, "click"]], template: function ChangepwdComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ChangepwdComponent_Template_a_click_18_listener() { return ctx.updatePwd(); });
...
class OtpComponent {
    ...
    check(event) {
        if (event.target.value.length == 4) {
            ...
            this._apiService.postRequest('api/v1/admin/otp', obj).subscribe((response) => {
                console.log("response", response);
                this._commService.successMsg(response.message);
...
OtpComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: OtpComponent, selectors: [["app-otp"]], decls: 16, vars: 3, consts: [["mat-dialog-content", ""], [1, "singin_content", "recoverpassword", "verfiy"], [1, "signin_right", "otp-screen"], [1, "signin_right_inner"], [1, "otp-text"], [1, "input_field"], [3, "formGroup"], [1, "signin_form"], ["type", "text", "placeholder", "Enter code", "formControlName", "otp", 3, "keyup", "keypress"], [4, "ngIf"], [1, "signup-btngroup"], [1, "btn", "btn-primary", 3, "click"]], template: function OtpComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "div", 1);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](2, "div", 2);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](3, "div", 3);
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("keyup", function OtpComponent_Template_input_keyup_10_listener($event) { return ctx.check($event); })("keypress", function OtpComponent_Template_input_keypress_10_listener($event) { return ctx.phoneNoInput($event); });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
