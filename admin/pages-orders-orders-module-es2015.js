...
OrderDetailComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: OrderDetailComponent, selectors: [["app-order-detail"]], decls: 88, vars: 0, consts: [[1, "row"], [1, "col-md-12", "text-right", "mb-3"], ["routerLink", "/orders/orderslist", "routerLinkActive", "router-link-active", 1, "btn", "btn-primary"], [1, "col-md-12"], [1, "card", "card-body", "printableArea"], [1, "pull-right"], [1, "pull-left"], [1, "font-bold"], [1, "text-muted", "m-l-30"], [1, "pull-right", "text-right"], [1, "m-t-30"], [1, "fa", "fa-calendar"], [1, "table-responsive", "m-t-40", 2, "clear", "both"], [1, "table", "table-hover"], [1, "text-center"], [1, "text-right"], [1, "pull-right", "m-t-30", "text-right"], [1, "clearfix"]], template: function OrderDetailComponent_Template(rf, ctx) { if (rf & 1) {
...
function OrdersListComponent_tr_40_Template(rf, ctx) { if (rf & 1) {
...
/* harmony import */ var _orders_list_orders_list_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./orders-list/orders-list.component */ "./src/app/pages/orders/orders-list/orders-list.component.ts");
/* harmony import */ var _order_detail_order_detail_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./order-detail/order-detail.component */ "./src/app/pages/orders/order-detail/order-detail.component.ts");
...
OrdersComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: OrdersComponent, selectors: [["app-orders"]], decls: 1, vars: 0, template: function OrdersComponent_Template(rf, ctx) { if (rf & 1) {
...
/* harmony import */ var _orders_list_orders_list_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./orders-list/orders-list.component */ "./src/app/pages/orders/orders-list/orders-list.component.ts");
/* harmony import */ var _order_detail_order_detail_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./order-detail/order-detail.component */ "./src/app/pages/orders/order-detail/order-detail.component.ts");
