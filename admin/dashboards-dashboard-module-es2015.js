...
ProjectCounterComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: ProjectCounterComponent, selectors: [["app-project-counter"]], inputs: { items: ["item", "items"] }, decls: 16, vars: 4, consts: [[1, "m-b-30"], [1, "card", "mb-2", 2, "cursor", "pointer"], ["class", "card-body", 4, "ngIf"], [1, "card", "mb-2"], [1, "card-body"], [1, "row"], [1, "col-12"], [1, "m-b-0", "text-success"], [1, "mdi", "mdi-alert-circle"], [1, ""], [1, "card-subtitle"], ["type", "success", 3, "showValue", "value"], ["routerLink", "/users/userlist", 1, "col-12"], [1, "m-b-0", "text-info"], [1, "mdi", "mdi-account-multiple"], ["type", "info", 3, "showValue", "value"]], template: function ProjectCounterComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "div", 1);
