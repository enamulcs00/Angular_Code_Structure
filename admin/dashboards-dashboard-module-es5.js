  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["dashboards-dashboard-module"], {
    ...
    function srcAppDashboardsDashboardComponentsProjectCounterProjectCounterComponentTs(module, __webpack_exports__, __webpack_require__) {
      ...
      ProjectCounterComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        decls: 15,
        vars: 4,
        consts: [[1, "m-b-30"], [1, "card", "mb-2", 2, "cursor", "pointer"], ["class", "card-body", 4, "ngIf"], [1, "card", "mb-2"], [1, "card-body"], [1, "row"], [1, "col-12"], [1, "m-b-0"], [1, "mdi", "mdi-alert-circle", "text-success"], [1, ""], [1, "card-subtitle"], ["type", "success", 3, "showValue", "value"], ["routerLink", "/users/userlist", 1, "col-12"], [1, "mdi", "mdi-account-multiple", "text-info"], ["type", "info", 3, "showValue", "value"]],
