    ...
    function node_modulesAngularMaterialFesm2015FormFieldJs(module, __webpack_exports__, __webpack_require__) {
      ...
      var MatFormField = /*#__PURE__*/function (_MatFormFieldMixinBas) {
        ...
        function MatFormField(_elementRef, _changeDetectorRef, labelOptions, _dir, _defaults, _platform, _ngZone, _animationMode) {
          ...
          _this3._outlineGapCalculationNeededImmediately = false;
          /** Whether the outline gap needs to be calculated next time the zone has stabilized. */

          _this3._outlineGapCalculationNeededOnStable = false;
          ...
          _this3._subscriptAnimationState = '';
          _this3._hintLabel = ''; // Unique id for the hint label.

          _this3._hintLabelId = "mat-hint-".concat(nextUniqueId$2++); // Unique id for the internal form field label.

          _this3._labelId = "mat-form-field-label-".concat(nextUniqueId$2++);
          _this3._labelOptions = labelOptions ? labelOptions : {};
          _this3.floatLabel = _this3._getDefaultFloatLabelState();
          _this3._animationsEnabled = _animationMode !== 'NoopAnimations'; // Set the default through here so we invoke the setter on the first run.

          _this3.appearance = _defaults && _defaults.appearance ? _defaults.appearance : 'legacy';
          _this3._hideRequiredMarker = _defaults && _defaults.hideRequiredMarker != null ? _defaults.hideRequiredMarker : false;
          return _this3;
        }
        ...
        _createClass(MatFormField, [{
          ...
          value: function ngAfterContentInit() {
            ...
            control.stateChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["startWith"])(null)).subscribe(function () {
              _this4._validatePlaceholders();

              _this4._syncDescribedByIds();
            ...
            this._ngZone.runOutsideAngular(function () {
              _this4._ngZone.onStable.asObservable().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["takeUntil"])(_this4._destroyed)).subscribe(function () {
                if (_this4._outlineGapCalculationNeededOnStable) {
                  _this4.updateOutlineGap();
                }
              });
            ...
            Object(rxjs__WEBPACK_IMPORTED_MODULE_6__["merge"])(this._prefixChildren.changes, this._suffixChildren.changes).subscribe(function () {
              _this4._outlineGapCalculationNeededOnStable = true;
                ...
                if (typeof requestAnimationFrame === 'function') {
                  _this4._ngZone.runOutsideAngular(function () {
                    requestAnimationFrame(function () {
                      return _this4.updateOutlineGap();
                    });
                  });
                } else {
                  _this4.updateOutlineGap();
            ...
            if (this._hasFloatingLabel() && this._canLabelFloat()) {
              ...
              if (this._animationsEnabled && this._label) {
                ...
                Object(rxjs__WEBPACK_IMPORTED_MODULE_6__["fromEvent"])(this._label.nativeElement, 'transitionend').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["take"])(1)).subscribe(function () {
                  _this5._showAlwaysAnimate = false;
                });
              }
...
//# sourceMappingURL=default~pages-notification-notification-module~pages-others-others-module~pages-sub-admin-sub-admin-~b193c330-es5.js.map